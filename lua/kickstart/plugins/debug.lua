...
return {
  ...
  config = function()
    ...
    local function get_python_path()
      local venv_paths = {
        os.getenv 'VIRTUAL_ENV', -- Active virtual environment
        vim.fn.getcwd() .. '/.venv/bin/python', -- Project-specific .venv
        vim.fn.getcwd() .. '/venv/bin/python', -- Alternative common name
        vim.fn.expand '~/.virtualenvs/debugpy/bin/python', -- Fallback global virtualenv
